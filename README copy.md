...
<details>
  ...
  * Data de entrega para avaliação final do projeto: `19/01/2023 14:00`.
...
- Você deve criar uma branch no seguinte formato: `nome-de-usuario-nome-do-projeto`
  * Exemplo: `git checkout -b maria-sd-022-a-trybe-futebol-clube`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-022-a-trybe-futebol-clube`
...
<details>
  ...
  - Vá até a página DO SEU Pull Request, adicione a label de "code-review" e marque seus colegas
    ...
    - No menu à direita, clique no *link* "Reviewers" e digite students, selecione o time tryber/students-sd-022-a
